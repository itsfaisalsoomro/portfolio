              ...
              <div className="contact-info contact-info-border-start d-flex flex-column">
                ...
                <ul className="social-icon">
                  <li className="social-icon-item">
                    <a
                      href="https://www.linkedin.com/in/itsfaisalsoomro/"
                  ...
                  <li className="social-icon-item">
                    <a
                      href="https://github.com/itsfaisalsoomro"
                      className="social-icon-link "
                    >
                  ...
                  <li className="social-icon-item">
                    <a href="/" className="social-icon-link">
                      <SiUpwork style={{ marginBottom: "3px" }} />
                      {/* Icon */}
                    </a>
                  </li>
                  ...
                  <div className="col-lg-3 col-md-6 col-6">
                    <div className="form-check form-check-inline">
                      ...
                      >
                        ...
                        <span className="form-check-label-text">WordPress</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-3 col-md-6 col-6">
                    <div className="form-check form-check-inline">
                      ...
                      >
                        ...
                        <span className="form-check-label-text">WebApp</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-3 col-md-6 col-6">
                    <div className="form-check form-check-inline">
                      ...
                      >
                        ...
                        <span className="form-check-label-text">UI / UX</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-3 col-md-6 col-6">
                    <div className="form-check form-check-inline me-0">
                      ...
                      >
                        ...
                        <span className="form-check-label-text">Wix</span>
                      </label>
                    </div>
                  </div>
