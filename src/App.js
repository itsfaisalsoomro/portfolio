import "./App.css";
import img01 from "../src/assets/images/happy-bearded-young-man.jpg";
import img02 from "../src/assets/images/portrait-happy-excited-man-holding-laptop-computer.png";
import img03 from "../src/assets/images/couple-working-from-home-together-sofa.jpg";
import img04 from "../src/assets/images/happy-bearded-young-man.jpg";
import img05 from "../src/assets/images/clients/cachet.svg";
import img06 from "../src/assets/images/clients/guitar-center.svg";
import img07 from "../src/assets/images/clients/tokico.svg";
import img08 from "../src/assets/images/clients/shopify.svg";
import img09 from "../src/assets/images/clients/profil-rejser.svg";
...
import img12 from "../src/assets/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg";
import img13 from "../src/assets/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg";
import img14 from "../src/assets/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg";
import img15 from "../src/assets/images/aerial-view-man-using-computer-laptop-wooden-table.jpg";

function App() {
  return (
    <>
      <section classNameName="preloader">
            ...
            <div className="row">
              <div className="col-lg-7 col-12">
                <div className="hero-text">
                  ...
                  <p className="mb-4">
                    <a className="custom-btn btn custom-link" href="/">
                      Let's begin
                    </a>
                  </p>
                </div>
              ...
              <div className="col-lg-5 col-12 position-relative">
                ...
                <img src={img02} className="hero-image img-fluid" alt="" />
              </div>
            </div>
          </div>
              ...
              <div className="col-lg-6 col-12 mt-5 mt-lg-0">
                <div className="about-thumb">
                  ...
                  <p>
                    ...
                    <a href="/">TemplateMo</a>. This layout is based on
                    Bootstrap v5.1.3 CSS and JS libraries. Image credits go to{" "}
                    <a href="/">Unsplash</a> and <a href="/">FreePik</a> for
                  ...
                  <p>
                    ...
                    other website. Please <a href="/">contact us</a> for more
                    info.
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-md-8 col-12">
                <div className="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                  <img src={img15} className="avatar-image img-fluid" alt="" />
              ...
              <div className="col-lg-3 col-md-6 col-12 pe-lg-0">
                <div className="contact-info contact-info-border-start d-flex flex-column">
                  ...
                  <p className="mb-0">I am available for freelance projects</p>
                </div>
              </div>
